...
uint16_t cfg_bt_music_normal_latency   = 250;       //lhdc 1000kbps时帧长626bytes, 故32K buffer最大只能缓存261ms
uint8_t cfg_bt_lhdc_codec_feature = 0;
const u16 sbc_inbuf_size = 0x8000;                  //32K
#endif

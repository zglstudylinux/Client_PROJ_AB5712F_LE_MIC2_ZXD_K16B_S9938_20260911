...
#ifndef USER_CONFIG_BROADCAST_H
#define USER_CONFIG_BROADCAST_H
...
#define WIRELESS_CON_VERS                       8               //传输机制版本(2=V3一般用于k歌话筒, 6=V7一般用于领夹麦, 8=V9用于一拖多)
...
#define WIRELESS_MIC_ENC_MAX_US             800             //编码运算时长（单位us）

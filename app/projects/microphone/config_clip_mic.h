...
#define WIRELESS_CON_VERS                       6               //传输机制版本(2=V3一般用于k歌话筒, 6=V7一般用于领夹麦, 8=V9用于一拖多, 9=V10用于2T2R)
...
#define WIRELESS_MIC_RETRY_NB               6               //重传次数（暂时支持1/2）
#define WIRELESS_MIC_ENC_MAX_US             1000             //编码运算时长（单位us）
#define WIRELESS_MIC_DEC_MAX_US             1500            //解码运算时长（单位us，开PLC时约900us）
...
#define WIRELESS_MIC_I2S_INPUT_EN               0               //设备端I2S输入功能
...
#define ADAPTER_HUART_OUTPUT_EN                 0               //适配器是否支持HUART输出MIC音频,使用DMA输出。可以同时DAC输出（系统时钟需设置为，SYS_160M）
#define ADAPTER_HUART_INPUT_EN                  0               //适配器是否支持HUART输入数字信号（系统时钟需设置为，SYS_160M）
#define ADAPTER_HUART_COMMAND_EN                0               //适配器是否支持HUART音频命令(用于将HUART TX端的数据命令同步到HUART RX端)
#define ADAPTER_HUART_MSG_EN                    0               //适配器是否支持HUART MSG(主要用于'adapter主'发送MSG给'adapter副')
/*****************************************************************************
 * Module    : SD0配置
 *****************************************************************************/
...
#define SOFT_DRC_DUMP_EN                        0               //打印算法数据（调试用）
...
#define CHARGE_5V_POWER_SUPPLY_EN       0           //是否支持VUSB 5V供电

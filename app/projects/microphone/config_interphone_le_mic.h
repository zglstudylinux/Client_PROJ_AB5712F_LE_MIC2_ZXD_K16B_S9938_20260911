...
#ifndef USER_CONFIG_INTERFACE_LE_MIC_H
#define USER_CONFIG_INTERFACE_LE_MIC_H
...
#define WIRELESS_MIC_ENC_MAX_US             1600             //编码运算时长（单位us）
#define WIRELESS_MIC_DEC_MAX_US             1600            //解码运算时长（单位us，开PLC时约900us）
#define WIRELESS_MIC_TX_INTERVAL            10               //传输周期=n*1.25ms（默认值是2，改为4时传输次数可增加到5次）
...
#define WIRELESS_SPK_CHANNEL_SELECT             1               //无线spk声道选择，1为单声道，2为双声道
#define WIRELESS_SPK_FRAME_SIZE                 25              //每帧压缩后大小（FRAME_SIZE*LINK_NB*RETRY_NB暂时不能超过250byte）
...
#define DEVICE_STEREO_EN                        0               //立体声对讲机
#define WIRELESS_INTERPHONE_AEC_EN              0               //对讲机AEC算法
...
#define WIRELESS_MIC_DAC_OUTPUT_EN              1               //发射端是否使能DAC输出
...
#define ADAPTER_DAC_OUTPUT_EN                   0               //适配器dac输出
 ...
 * Module    : 外部PA/LNA配置
 *****************************************************************************/
#define BT_RF_EXT_CTL_EN                1              //使能外部PA/LAN
#define RF_EN_GP                        E
#define RF_TX_GP                        E
#define RF_RX_GP                        E
#define RF_EN_BIT                       BIT(6)
#define RF_TX_BIT                       BIT(7)

...
#ifndef USER_CONFIG_LOW_LATENCY_H
#define USER_CONFIG_LOW_LATENCY_H
...
#define WIRELESS_MIC_ENC_MAX_US             450             //编码运算时长（单位us）
#define WIRELESS_MIC_DEC_MAX_US             700            //解码运算时长（单位us，开PLC时约500us）

...
#ifndef USER_CONFIG_WIRELESS_MIC_H
#define USER_CONFIG_WIRELESS_MIC_H
...
#define WIRELESS_CON_CON_ID_SEL2                0x05            //无线mic连接id，需要发射端跟接收端id一致才可连接，可以调用ble_set_con_id来动态修改id，实现动态连接
#define WIRELESS_CON_PAIR_MODE                  1               //是否使能配对码功能(一拖二两个发射端连接id不同,需要配合WIRELESS_CON_CON_ID_SEL使用)
...
#define WIRELESS_MIC_ENC_MAX_US             700             //编码运算时长（单位us）
#define WIRELESS_MIC_DEC_MAX_US             1200            //解码运算时长（单位us，开PLC时约900us）
...
#define MIC_DRC_EN                              1              //发射器是否开启数字增益控制
 ...
 *****************************************************************************/
 ...
 #define SOFT_GAIN_MAX_LEVEL                     17               //soft gain音量等级划分，按照固定的间隔划分成这么多等级，用于后续等级加减
#define SOFT_GAIN_DEFAULT_LEVEL                 4               //soft gain音量第一次上电默认等级 range:1-SOFT_GAIN_MAX_LEVEL
...
#define ECHO_LEVEL			                    80              //attenuation  range:0-90
#define ECHO_DRY_USER                           32767           //干度 range:0-32767
#define ECHO_WET_USER                           8000           //湿度 range:0-32767
#define ECHO_DELAY_MAX_LEVEL                    3               //echo延迟等级划分，按照固定的间隔划分成这么多等级，用于后续等级加减
#define ECHO_DELAY_DEFAULT_LEVEL                1               //echo第一次上电默认等级 range:1-ECHO_DELAY_MAX_LEVEL
...
#define VBAT_FILTER_USE_PEAK            1           //电池检测滤波方式: 0=取平均值，1=取峰值(适用于播音乐时电池波动较大的音箱方案).

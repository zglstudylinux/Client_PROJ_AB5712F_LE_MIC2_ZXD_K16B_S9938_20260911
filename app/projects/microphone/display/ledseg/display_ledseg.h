...
#define ICON_SD         0x00
#define ICON_DDOT       0x00
#define ICON_MP3        0x00
#define ICON_FM         0x00
#define ICON_AUX        0x00

#define ICON_MHZ         SEG_A
#define ICON_BT         SEG_B
#define ICON_WIR_A         SEG_C
#define ICON_WIR_B         SEG_D
#define ICON_VBAT         SEG_E
#define ICON_VBAT1         SEG_F
#define ICON_VBAT2         SEG_G
#define ICON_VBAT3         SEG_H
